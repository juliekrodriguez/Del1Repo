...
import julie.structMethod.MaintainabilityIndexCheck;

public class MaintainabilityIndexCheckTest {
    private int[] reqTok = new int[0];
    private MaintainabilityIndexCheck mic = new MaintainabilityIndexCheck();
    
    // init
    private int[] acceptableTok=
        {
                ...
                TokenTypes.LAND, TokenTypes.LOR, TokenTypes.SEMI, TokenTypes.LITERAL_VOID, TokenTypes.LITERAL_BOOLEAN, 
    ...
    {
        assertArrayEquals(defTok, mic.getDefaultTokens());
    }
    @Test
    public void getAcceptableTokTest()
    {
        assertArrayEquals(acceptableTok, mic.getAcceptableTokens());
    }
    @Test
    public void getReqTok()
    {
        assertArrayEquals(reqTok, mic.getRequiredTokens());
    }
