...
import julie.structMethod.HalsteadLengthCheck;



public class HLengthCheckTest {
  ...
  public void testGetDefaultTokens() {
    assertArrayEquals(defaultTokens, hlc.getDefaultTokens());
  }

  @Test
  public void testGetAcceptableTokens() {
    assertArrayEquals(acceptableTokens, hlc.getAcceptableTokens());
  }

  @Test
  public void testGetRequiredTokens() {
    assertArrayEquals(requiredTokens, hlc.getRequiredTokens());
  }
