...
public class AcceptTokens {
  ...
  public static int[] getOperators() {
    return new int[] { TokenTypes.DEC, TokenTypes.BNOT, TokenTypes.LNOT, TokenTypes.LITERAL_TRUE, 
            ...
            TokenTypes.SLIST, TokenTypes.IMPORT, TokenTypes.LCURLY, TokenTypes.LPAREN, TokenTypes.ARRAY_DECLARATOR, 
